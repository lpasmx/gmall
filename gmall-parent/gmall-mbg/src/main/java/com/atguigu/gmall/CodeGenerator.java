...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\workspring\\gmall\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        gc.setBaseResultMap(true);//生成xml的baseResultMap
        ...
        dsc.setUrl("jdbc:mysql://192.168.46.4:3316/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
