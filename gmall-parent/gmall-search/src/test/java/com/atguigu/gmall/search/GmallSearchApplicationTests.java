...
public class GmallSearchApplicationTests {
	...
	/**
	 * 保存/更新index  update delete get
	 */
	@Test
	public void index() throws IOException {
		//保存一个account
		Account account = new Account(88888L,66666L,"lei","pingan",20,"pa","mill road","student","lpa@qq.com","BJ","CP");
	...
	public void delete() throws IOException {
		//1.构建Action、
		Delete delete = new Delete.Builder("88888")
				.index("bank")
				.type("account")
				.build();
		//2/JestClient执行
	...
	public void searchFz() throws IOException {
		...
		//3,构建most_not
		boolQuery.mustNot(QueryBuilders.matchQuery("age",20));
		//4，构建should
	...
	public void aggs() throws IOException {
		...
		//封装term query
		searchSourceBuilder.query(builderQueryBuilder());
		//封装aggs
	...
	private QueryBuilder builderQueryBuilder(){
